...
(defun access-by-role (group-uris)
...
(supply-allowed-group "admin-rw"
  :query (access-by-role "<http://data.kanselarij.vlaanderen.be/id/group/admin>"))

(supply-allowed-group "kanselarij"
  :query (access-by-role "<http://data.kanselarij.vlaanderen.be/id/group/kanselarij>"))

(supply-allowed-group "minister"
  :query (access-by-role "<http://data.kanselarij.vlaanderen.be/id/group/minister>"))

(supply-allowed-group "kabinet-adviesverlener"
  :query (access-by-role
...
(grant (read)
  :to-graph (minister-agenda)
  :for-allowed-group "minister")

(grant (read)
  :to-graph (kabinet-agenda)
  :for-allowed-group "kabinet-adviesverlener")

(grant (read)
  :to-graph (administratie-agenda)
